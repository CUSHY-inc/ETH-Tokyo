...
const Describe = () => {
    ...
    const desc = "With over a decade of experience in sales and marketing, I have developed a keen understanding of what it takes to succeed in today's fast-paced business environment."
